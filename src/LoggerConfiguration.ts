/**
 * LoggerConfiguration manages the configuration of sinks, filters, formatters, and enrichers for the logger.
 *
 * Allows fluent configuration of pipelines for advanced logging scenarios.
 *
 * Example usage:
 *   const config = new LoggerConfiguration();
 *   config.writeTo(new ConsoleSink()).minimumLevel('Warning');
 */
